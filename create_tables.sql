-- n8n Due Diligence Database Schema
-- Execute this in PostgreSQL to create required tables
...
-- Show test data
SELECT 'Database setup complete!' as status, company_name FROM dd_companies WHERE company_id = 'test_setup_001';
