      ...
      try {
        ...
        switch (operation) {
          ...
          case 'pitr':
            ...
            const confirmPitr = this.getNodeParameter('confirmDestructive', i);
          ...
          case 'restore':
            const backupFile = this.getNodeParameter('backupFile', i);
            const confirmRestore = this.getNodeParameter('confirmDestructive', i);
...
module.exports = { nodeClass: PostgreSQLRollback };
