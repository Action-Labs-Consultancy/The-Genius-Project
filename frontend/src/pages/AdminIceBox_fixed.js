...
const AdminIceBox = ({ user }) => {
  ...
  const loadRequests = async () => {
    try {
      ...
      setError('Failed to load requests. Using mock data for display.');
      ...
      const mockRequests = [
        {
          ...
          priority: 'high',
          status: 'pending',
          description: 'This is a sample request for testing the admin interface.',
          use_case: 'Testing the admin dashboard functionality',
          expected_outcome: 'Working admin interface with proper styling',
          submitted_by: { username: 'test_user' },
    ...
    <div style={{ 
      ...
      <div style={{ marginBottom: '40px', textAlign: 'center' }}>
        ...
        <p style={{ color: '#FFD700', margin: 0, opacity: '0.8', fontSize: '18px' }}>
          Feature Request Management Dashboard
        </p>
      </div>
